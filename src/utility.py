...
def toEuler(pos):
    # Extract the last four numbers as a quaternion
    target_quat = pos[3:7]

    # Convert quaternion to Euler angles
    euler_angles = quat2eulerZYX(target_quat, degree=True)

    # Construct the final array with first three positions and Euler angles
